<?php
/**
 * Post AJAX search directives partial.
 *
 * This partial returns data used to render search directives.
...
if ( ! $directives ) {
	$directives = SEOToolSetAPI::api_request( 'GET', "/posts/{$post_id}/directives" );
}

if ( isset( $directives['code'] ) ) {
	$alert = __( $directives['message'], SEOTOOLSET_TEXTDOMAIN );
