<?php
/**
 * Page keywords partial.
 *
 * This partial returns data used to render elements for keywords section.
 *
 * php version 7.2
 *
 * @category  SEOToolSet
...
?>
<div class="seotoolset wrap page-keywords">
...
try {
	SEOToolSet::require_user_project_subscribed( '/dashboard/keywords' );

	SEOToolSet::get_template( 'big-table-sorting', [ 'args' => $args ] );

	SEOToolSet::get_template(
		'ajax-keywords-table-sort',
		[
			'args'     => $args,
			'keywords' => $keywords,
		]
...
?>
	<script>
	SEOToolSet.events.bind('page-keywords');
	</script>
</div>
